    ...
    private void attemptRegister() {
        ...
        if (cancel) {
            ...
            if (Util.isNetworkAvailable(this)) {
                RoomMateFinderUser user = new RoomMateFinderUser();
                ...
                Backendless.UserService.register(user, new DefaultCallback<BackendlessUser>(RegisterActivity.this, "Registering the User. Please Wait..") {
                    ...
                    public void handleFault(BackendlessFault fault) {
                        ...
                        switch (fault.getCode()) {
                            case Defaults.REGISTRATION_ERROR:
                                message = getResources().getString(R.string.MSG_REGISTER_FAILED);
                                break;
                            case Defaults.REGISTRATION_FAILED:
                                message = getResources().getString(R.string.MSG_REGISTER_FAILED);
                                break;
                            case Defaults.REGISTRATION_EMAIL_WRONG:
                                message = getResources().getString(R.string.MSG_REGISTER_EMAIL_WRONG);
                                break;
                            case Defaults.REGISTRATION_USER_ALREADY_EXISTS:
                                message = getResources().getString(R.string.MSG_REGISTER_USER_ALREADY_EXISTS);
                                break;
                        }
